...
class NSRRModel(BaseModel):
    ...
    def forward(self, x_view, x_depth, x_flow):
        ...
        # back warp motion
        for i in range(1, self.number_previous_frames):
            tmp = self.motion_warping_function(
        ...
        print("all_features_upsampled.shape =", all_features_upsampled.shape)
        print("list_previous_features_warped[0].shape =", list_previous_features_warped[0].shape)
        print("list_previous_features_warped[1].shape =", list_previous_features_warped[1].shape)
        print("list_previous_features_warped[2].shape =", list_previous_features_warped[2].shape)
        print("list_previous_features_warped[3].shape =", list_previous_features_warped[3].shape)
        print("list_previous_features_warped[4].shape =", list_previous_features_warped[4].shape)
...
class NSRRFeatureReweightingModel(BaseModel):
    ...
    def forward(self,
        ...
        # current_features_upsampled_for_reweighting = [5, 4, 480, 720]
        # list_previous_features_warped = [5, 12, 480, 720] * 5
        reweight_feed_in = current_features_upsampled_for_reweighting
        print("reweight_feed_in.shape =", reweight_feed_in.shape)
        print("list_previous_features_warped[0].shape =", list_previous_features_warped[0].shape)
